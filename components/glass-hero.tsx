...
export default function GlassHero() {
  ...
  return (
    <div ref={containerRef} className="noise-bg select-none w-full bg-white overflow-x-hidden transition-colors duration-500">
      ...
      {/* 02 / SELECTED WORK — EXACT SPECIFICATION BLUEPRINT */}
      <section id="sec-showcase" className="story-sec bg-[#f8f9fa] text-zinc-900 py-20 sm:py-28 px-[max(5.6vw,1.5rem)] relative z-20 border-t border-zinc-200/60">
        ...
        <div className="max-w-[1400px] mx-auto flex flex-col gap-12 sm:gap-16">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between w-full border-b border-zinc-200 pb-8 gap-6">
            <div className="flex flex-col gap-4 max-w-2xl">
              <span className="inline-flex items-center gap-2 font-mono text-xs font-semibold tracking-[0.2em] text-blue-600 uppercase bg-blue-50/90 px-3.5 py-1.5 rounded-full border border-blue-200/60 shadow-2xs w-fit">
                <span className="w-1.5 h-1.5 rounded-full bg-blue-600 animate-pulse" />
                SELECTED WORK
              </span>
              <h2 id="sec-showcase-title" className="text-3xl sm:text-4xl md:text-5xl lg:text-[56px] font-semibold tracking-tight text-zinc-900 leading-[1.08]">
                Things I&apos;ve designed,<br className="hidden sm:inline" /> built &amp; shipped.
              </h2>
              <p className="text-zinc-500 font-light text-sm sm:text-base leading-relaxed max-w-xl">
              ...
              <div className="pt-1">
                <a 
                  ...
                  target="_blank" 
                  rel="noreferrer" 
                  className="font-mono text-xs font-semibold tracking-wider text-blue-600 hover:text-blue-700 uppercase inline-flex items-center gap-1.5 group transition-colors"
                >
          ...
          <div className="flex flex-col gap-8 sm:gap-12">
            {/* 2. FEATURED PROJECT — NO MORE DMS */}
            <div className="project-card-item w-full bg-white rounded-[2rem] border border-zinc-200/80 p-6 sm:p-8 lg:p-10 shadow-[0_8px_30px_rgba(0,0,0,0.04)] hover:shadow-[0_20px_50px_rgba(0,0,0,0.06)] transition-all duration-500 group">
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
                
                {/* Left portion: Project Info */}
                <div className="lg:col-span-5 flex flex-col justify-between h-full gap-6">
                  <div className="flex flex-col gap-4">
                    <div className="flex items-center gap-3">
                      <span className="font-mono text-xs font-semibold text-zinc-900 px-3 py-1 bg-zinc-100 rounded-full border border-zinc-200/80">
                        01
                      </span>
                      <span className="font-mono text-[10px] font-bold tracking-widest text-blue-600 uppercase bg-blue-50 px-2.5 py-1 rounded-md border border-blue-200/50">
                        FEATURED PROJECT
                      </span>
                    </div>
                    
                    <h3 className="text-3xl sm:text-4xl lg:text-5xl font-semibold tracking-tight text-zinc-900 leading-[1.1]">
                      NoMoreDMS
                    </h3>
                    
                    <p className="text-zinc-500 font-light leading-relaxed text-sm sm:text-base">
                      AI-powered job application &amp; creator platform to eliminate unnecessary DMs and connect opportunities in one smart hub.
                    </p>
                    
                    <div className="flex flex-wrap gap-2 pt-2">
                      {['Product Design', 'AI', 'Full Stack'].map((tag, i) => (
                        <span 
                          key={i} 
                          className="text-xs font-mono font-medium px-3.5 py-1.5 rounded-full bg-zinc-50 text-zinc-600 border border-zinc-200/80"
                        >
                          {tag}
                        </span>
                      ))}
                  ...
                  <div className="pt-2">
                    <MagneticButton>
                      <a 
                        ...
                        target="_blank" 
                        rel="noreferrer" 
                        className="inline-flex items-center gap-2 font-mono text-xs font-semibold text-white bg-zinc-900 hover:bg-black px-7 py-4 rounded-full transition-all duration-300 shrink-0 group/btn shadow-sm hover:shadow hover:scale-[1.02]"
                      >
                        <span>View case study</span>
                        <span className="group-hover/btn:translate-x-1.5 transition-transform duration-300">&rarr;</span>
                      </a>
                    </MagneticButton>
                  </div>
                </div>

                {/* Right portion: Large project website screenshot */}
                <div className="lg:col-span-7 w-full">
                  <a 
                    href="https://nomoredms.vercel.app/" 
                    target="_blank" 
                    rel="noreferrer" 
                    className="block w-full rounded-2xl overflow-hidden border border-zinc-200/80 bg-zinc-100/60 shadow-sm relative group/img cursor-pointer"
                  >
                    <img 
                      src="/images/projects/nomoredms.png" 
                      alt="NoMoreDMS - Featured Project Screenshot" 
                      className="w-full h-auto object-cover object-top rounded-2xl transition-transform duration-700 ease-[cubic-bezier(0.16,1,0.3,1)] group-hover/img:scale-[1.02]" 
                    />
                  </a>
                </div>
            ...
            {/* 3. SECONDARY PROJECT GRID */}
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8 w-full">
              
              {/* LEFT CARD: Project 02 — EduCalc */}
              <div className="project-card-item w-full bg-white rounded-[2rem] border border-zinc-200/80 p-6 lg:p-7 shadow-[0_8px_30px_rgba(0,0,0,0.04)] hover:shadow-[0_16px_40px_rgba(0,0,0,0.06)] transition-all duration-500 hover:-translate-y-1 group flex flex-col justify-between">
                <div className="grid grid-cols-1 sm:grid-cols-12 gap-6 items-center">
                  {/* Website preview on the left */}
                  <div className="sm:col-span-6 w-full">
                    <a 
                      href="https://educalc-expert0509.vercel.app/" 
                      target="_blank" 
                      rel="noreferrer" 
                      className="block w-full rounded-xl overflow-hidden border border-zinc-200/70 bg-zinc-100 shadow-xs relative aspect-[16/10] group/img cursor-pointer"
                    >
                      <img 
                        src="/images/projects/educalc.png" 
                        alt="EduCalc Screenshot" 
                        className="w-full h-full object-cover object-top transition-transform duration-700 ease-[cubic-bezier(0.16,1,0.3,1)] group-hover/img:scale-[1.02]" 
                      />
                    </a>
                  </div>
                  ...
                  <div className="sm:col-span-6 flex flex-col justify-between h-full gap-4">
                    <div className="flex flex-col gap-2.5">
                      <span className="font-mono text-xs font-semibold text-zinc-900 px-2.5 py-1 bg-zinc-100 rounded-full border border-zinc-200/80 w-fit">
                        02
                      </span>
                      <h3 className="text-2xl sm:text-3xl font-semibold tracking-tight text-zinc-900">
                        EduCalc
                      </h3>
                      <p className="text-zinc-500 font-light text-xs sm:text-sm leading-relaxed">
                        Smart educational platform that makes math, logic &amp; calculations easier for students and professionals.
                      </p>
                      <div className="flex flex-wrap gap-1.5 pt-1">
                        {['Product Design', 'Automation', 'Math Engine'].map((tag, i) => (
                          <span 
                            key={i} 
                            className="text-[11px] font-mono font-medium px-2.5 py-1 rounded-full bg-zinc-50 text-zinc-600 border border-zinc-200/80"
                          >
                            {tag}
                          </span>
                        ))}
              ...
              {/* RIGHT CARD: Project 03 — Personal Portfolio */}
              <div className="project-card-item w-full bg-white rounded-[2rem] border border-zinc-200/80 p-6 lg:p-7 shadow-[0_8px_30px_rgba(0,0,0,0.04)] hover:shadow-[0_16px_40px_rgba(0,0,0,0.06)] transition-all duration-500 hover:-translate-y-1 group flex flex-col justify-between">
                <div className="grid grid-cols-1 sm:grid-cols-12 gap-6 items-center">
                  {/* Website preview on the left */}
                  <div className="sm:col-span-6 w-full">
                    ...
                    >
                      <img 
                        src="/images/projects/personalportfolio.jpg" 
                  ...
                  <div className="sm:col-span-6 flex flex-col justify-between h-full gap-4">
                    <div className="flex flex-col gap-2.5">
                      ...
                      <p className="text-zinc-500 font-light text-xs sm:text-sm leading-relaxed">
                        A personal portfolio that blends clean design, motion and interaction to create a unique digital presence.
                      </p>
                      <div className="flex flex-wrap gap-1.5 pt-1">
                        {['UX / UI Design', 'Development', 'Motion'].map((tag, i) => (
                          <span 
                            key={i} 
                            className="text-[11px] font-mono font-medium px-2.5 py-1 rounded-full bg-zinc-50 text-zinc-600 border border-zinc-200/80"
                          >
            ...
            {/* 4. COMPACT PROJECT ARCHIVE */}
            <div className="w-full bg-white rounded-[2rem] border border-zinc-200/80 p-4 sm:p-6 lg:p-8 shadow-[0_8px_30px_rgba(0,0,0,0.04)] flex flex-col divide-y divide-zinc-200/60 overflow-hidden">
              {[
                {
                  id: '04',
                  title: 'PostLearn',
                  desc: 'Modern learning platform delivering educational content intuitively.',
                  tags: ['Product Design', 'Next.js', 'Web App'],
                  url: 'https://postlearn-lake.vercel.app/',
                  thumb: '/images/projects/postlearn.png'
                },
                {
                  ...
                  title: 'Cozy Cafe',
                  desc: 'Bespoke cafe website featuring online menus and reservation flows.',
                  tags: ['Brand Identity', 'Next.js', 'Full Stack'],
                  url: 'https://cozy-cafa1.netlify.app/',
                  thumb: '/images/projects/cozy-cafe.png'
                },
                {
                  ...
                  title: 'Akshith Portfolio',
                  desc: 'Personal portfolio built for a client to establish digital presence.',
                  tags: ['Design System', 'GSAP Motion', 'Frontend'],
                  url: 'https://maatoori-akshith.netlify.app/',
                  thumb: '/images/projects/maatoori-akshith.jpg'
                }
              ].map((item) => (
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="project-card-item group flex items-center justify-between py-5 sm:py-6 px-3 sm:px-5 -mx-1 sm:-mx-2 rounded-2xl hover:bg-zinc-50/90 transition-all duration-300 gap-4"
                  onMouseEnter={() => setHoveredProjectImage(item.thumb)}
                  onMouseLeave={() => setHoveredProjectImage(null)}
                >
                  {/* Left info */}
                  <div className="flex items-center gap-4 sm:gap-8 min-w-0">
                    <span className="font-mono text-xs sm:text-sm font-semibold text-zinc-400 group-hover:text-blue-600 transition-colors shrink-0">
                      {item.id}
                    </span>
                    <div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-6 min-w-0">
                      <h4 className="text-lg sm:text-xl font-semibold text-zinc-900 group-hover:translate-x-1 transition-transform duration-300 shrink-0">
                        {item.title}
                      </h4>
                      <p className="text-zinc-500 font-light text-xs sm:text-sm hidden md:block truncate max-w-xs lg:max-w-md">
                        {item.desc}
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-3 sm:gap-6 shrink-0">
                    <div className="hidden sm:flex items-center gap-1.5">
                      {item.tags.slice(0, 3).map((tag, i) => (
                        <span
                          key={i}
                          className="text-[10px] sm:text-[11px] font-mono font-medium px-2.5 py-1 bg-zinc-100 text-zinc-600 rounded-full border border-zinc-200/60 whitespace-nowrap"
                        >
                          {tag}
                        </span>
                      ))}
                    ...
                    {/* Small project thumbnail on the right */}
                    <div className="w-16 h-10 sm:w-24 sm:h-14 rounded-lg overflow-hidden border border-zinc-200/80 bg-zinc-100 shadow-2xs relative shrink-0 opacity-85 group-hover:opacity-100 group-hover:scale-105 transition-all duration-300">
                      <img
                        src={item.thumb}
                        alt={item.title}
                    ...
                    <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-full bg-zinc-100 border border-zinc-200/80 flex items-center justify-center text-zinc-700 group-hover:bg-zinc-900 group-hover:text-white group-hover:border-zinc-900 transition-all duration-300 shrink-0 group-hover:translate-x-1">
            ...
            {/* 5. FINAL CTA */}
            <div className="project-card-item w-full bg-white rounded-[2rem] border border-zinc-200/80 p-8 sm:p-10 lg:p-12 shadow-[0_8px_30px_rgba(0,0,0,0.04)] flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
              ...
              <MagneticButton>
                <a 
                  href="mailto:devendhargopagoni@gmail.com" 
                  className="inline-flex items-center gap-2.5 font-mono text-xs sm:text-sm font-semibold text-white bg-zinc-900 hover:bg-black px-8 py-4 rounded-full transition-all duration-300 shrink-0 group shadow-sm hover:shadow hover:scale-[1.02]"
                >
